...
RUNTIME_SKILL_READ_PARAM_PATCH="$RUNTIME_SKILL_DIR/read_file_param.yml"
RUNTIME_SKILL_READ_PARAM_SATISFIED="$RUNTIME_SKILL_DIR/read_file_param.satisfied.yml"
...
apply_conditional_patch "Skill-by-name read_file param" "$RUNTIME_SKILL_READ_PARAM_PATCH" "$RUNTIME_SKILL_READ_PARAM_SATISFIED" "$RUNTIME_SKILL_READ_SOURCE"
...
assert_postcondition "Skill-by-name read_file param" "$RUNTIME_SKILL_READ_PARAM_SATISFIED" "$RUNTIME_SKILL_READ_SOURCE"
